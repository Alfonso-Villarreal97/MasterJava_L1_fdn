...
public class Ejercicio04_ArreglosMayorConcurrencia {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arreglo.length; i++) { // i = 0; 0 < 10; i++
            int cantidad = 0;
            for (int j = 0; j < arreglo.length; j++) { //j=0; 0<10; j++
                if (arreglo[i] == arreglo[j]) { // 5 == 2
                    cantidad++;
                }
            }
            arregloCantidadValores[i] = cantidad; // 1,
        }
