...
public class Ejemplo13_ArregloNotasAlumnos {
    public static void main(String[] args) {
        ...
        for (int i = 0; i<7;i++){
            ...
            sumNotasHistoria += claseMatematicas[i];
        ...
        System.out.println("Promedio de la clase matemáticas: " + promedioMatematicas);
        System.out.println("Promedio de la clase historia: " + promedioHistoria);
        System.out.println("Promedio de la clase lenguaje: " + promedioLenguaje);
